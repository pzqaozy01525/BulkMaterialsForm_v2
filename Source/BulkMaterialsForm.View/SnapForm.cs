...
// Type: BulkMaterialsForm.View.SnapForm
...
public class SnapForm : Form
{
	...
	{
		SnapSetForm snapSetForm = new SnapSetForm();
		snapSetForm.ShowDialog();
		if (snapSetForm.isSave)
		{
			InitData();
		}
	}
	...
	private void barButtonItem3_ItemClick(object sender, ItemClickEventArgs e)
	{
		...
		int id = Convert.ToInt32(dataGridView1.Rows[num].Cells["id"].Value);
		if (MessageBox.Show("确认删除该大屏配置信息？", "确认删除", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) == DialogResult.Yes)
		{
			if (new DataServerContext<tb_videotape>().Current.Delete((tb_videotape it) => it.id == id))
			{
	...
	{
		List<tb_videotape> list = new DataServerContext<tb_videotape>().Current.GetList();
		if (list != null)
		{
			dataGridView1.DataSource = list;
			dataGridView1.Columns["IP"].HeaderText = "IP";
			dataGridView1.Columns["doccode"].HeaderText = "账号";
			dataGridView1.Columns["pass"].HeaderText = "密码";
			dataGridView1.Columns["ChannelID"].HeaderText = "通道ID";
			dataGridView1.Columns["snapNumber"].HeaderText = "抓拍间隔";
	...
	private void InitializeComponent()
	{
		...
		this.barDockControl1.Location = new System.Drawing.Point(932, 40);
		this.barDockControl1.Manager = this.barManager1;
		this.barDockControl1.Size = new System.Drawing.Size(0, 500);
		...
		this.dataGridView1.Size = new System.Drawing.Size(932, 500);
		this.dataGridView1.TabIndex = 5;
		base.AutoScaleDimensions = new System.Drawing.SizeF(6f, 12f);
		base.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
		base.ClientSize = new System.Drawing.Size(932, 540);
