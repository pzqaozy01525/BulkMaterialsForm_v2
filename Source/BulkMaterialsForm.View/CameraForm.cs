...
// Type: BulkMaterialsForm.View.CameraForm
...
public class CameraForm : Form
{
	...
	{
		List<DeviceView> list = new DataServerContext<DeviceView>().Current.DbContext().Queryable((tb_Device a, tb_Channel b, tb_Device c) => new object[4]
		{
			JoinType.Left,
			a.ChannelNo == b.id,
			JoinType.Left,
			a.OpeningMethod == c.id.ToString()
		}).Select((tb_Device a, tb_Channel b, tb_Device c) => new DeviceView
		{
			CameraName = a.CameraName,
			CameraBrand = a.CameraBrand,
			CameraIP = a.CameraIP,
			CameraType = a.CameraType,
			motherboardType = a.motherboardType,
			ChannelName = b.ChannelName,
			OpeningMethod = c.CameraName,
			IOIP = a.IOIP,
			bjip = a.bjip,
			id = a.id
		})
		...
		foreach (DeviceView item in list)
		{
			if (item.OpeningMethod == null || item.OpeningMethod == "0")
			{
				item.OpeningMethod = "自身";
			}
		}
		dataGridView1.DataSource = list;
		dataGridView1.Columns["CameraName"].HeaderText = "设备名称";
		dataGridView1.Columns["ChannelName"].HeaderText = "所属通道";
		dataGridView1.Columns["CameraBrand"].HeaderText = "品牌";
		dataGridView1.Columns["CameraIP"].HeaderText = "IP地址";
		dataGridView1.Columns["OpeningMethod"].HeaderText = "开闸方式";
		dataGridView1.Columns["CameraType"].HeaderText = "设备类型";
		dataGridView1.Columns["motherboardType"].HeaderText = "主板类型";
		dataGridView1.Columns["IOIP"].HeaderText = "I/O模块地址";
		dataGridView1.Columns["bjip"].HeaderText = "报警地址";
		dataGridView1.Columns["id"].Visible = false;
		dataGridView1.Columns["ChannelNo"].Visible = false;
	...
	private void barButtonItem3_ItemClick(object sender, ItemClickEventArgs e)
	{
		...
		int id = Convert.ToInt32(dataGridView1.Rows[num].Cells["id"].Value);
		if (MessageBox.Show("确认删除该设备配置？", "确认删除", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) == DialogResult.Yes)
		{
			if (new DataServerContext<tb_Device>().Current.Delete((tb_Device it) => it.id == id))
			{
	...
	private void InitializeComponent()
	{
		...
		this.barButtonItem1.TabIndex = 1;
		...
		this.barButtonItem2.TabIndex = 2;
		...
		this.barButtonItem3.TabIndex = 3;
		...
		this.barButtonItem4.TabIndex = 4;
		...
		this.barDockControlTop.Size = new System.Drawing.Size(847, 40);
		...
		this.barDockControl1.Location = new System.Drawing.Point(847, 40);
		this.barDockControl1.Manager = this.barManager1;
		this.barDockControl1.Size = new System.Drawing.Size(0, 444);
		...
		this.labelEmpty.AutoSize = false;
		this.labelEmpty.Dock = System.Windows.Forms.DockStyle.Fill;
		this.labelEmpty.Font = new System.Drawing.Font("微软雅黑", 9f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 134);
