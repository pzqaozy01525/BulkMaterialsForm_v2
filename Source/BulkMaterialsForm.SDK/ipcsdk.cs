...
// Type: BulkMaterialsForm.SDK.ipcsdk
...
public class ipcsdk
{
	...
	public delegate void ICE_IPCSDK_OnIOEvent(IntPtr pvParam, [In][MarshalAs(UnmanagedType.LPStr)] string pcIP, uint u32EventType, uint u32IOData1, uint u32IOData2, uint u32IOData3, uint u32IOData4);

	[DllImport(".\\HX\\ice_ipcsdk.dll", CallingConvention = CallingConvention.Cdecl)]
