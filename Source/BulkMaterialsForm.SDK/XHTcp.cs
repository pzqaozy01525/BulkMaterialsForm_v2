...
// Type: BulkMaterialsForm.SDK.XHTcp
...
public class XHTcp
{
	...
	public void Init()
	{
		...
		IPEndPoint localEP = new IPEndPoint(IPAddress.Parse(MqttHostService.GetCurrentComputerIP()), 9055);
	...
	private static void watchconnecting()
	{
		try
		{
			...
			while (true)
			{
				...
				_ = (socket.RemoteEndPoint as IPEndPoint).Port;
